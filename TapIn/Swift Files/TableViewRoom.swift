...
struct TableViewRoom: View {
    ...
    // ✅ Navigation environment variable to handle the Log Out button
    ...
    var body: some View {
        ...
        ZStack(alignment: .leading) {
            ...
            VStack {
                ...
                // ✅ NEW: Dedicated, obvious Log Out button at the top left
                HStack {
                ...
                // The Main Room Header
                HStack {
                    Image(systemName: "chevron.left")
                        .font(.title)
                        .foregroundColor(.white.opacity(0.5)) // Dimmed to look decorative
