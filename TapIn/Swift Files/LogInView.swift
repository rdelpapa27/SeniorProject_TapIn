...
struct PasscodeView: View {
    ...
    // ✅ NEW: Global storage for the logged-in user's name
    @AppStorage("currentServerName") private var currentServerName = ""
        ...
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                LazyVGrid(columns: columns, spacing: 20) {
                    ...
                    keypadButton(title: "xmark.circle", isSystemImage: true, action: clearPasscode)
    ...
    func validatePin() {
        ...
        db.collection("users")
            ...
            .getDocuments { snapshot, error in
                ...
                // ✅ NEW: Extract their name and save it to AppStorage!
                let employeeName = doc.get("name") as? String ?? "Unknown Server"
                currentServerName = employeeName
